...
SELECT '2026-03-14', '11791', 'Casco danificado irreparavelmente', 'Desenvolvedor (Mestre)', NULL, NULL, NULL, '2cce6373-6ecc-4bf3-a44c-1df959d7cc84'
WHERE NOT EXISTS (
  SELECT 1 FROM log_baixa_extintores b
  WHERE b.numero_identificacao = '11791'
