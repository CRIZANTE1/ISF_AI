...
def process_calibration_pdf_analysis(pdf_file):
    ...
    if not inventory_data.empty:
        existing_detector = inventory_data[inventory_data['numero_serie'] == serial_number]
...
def update_cylinder_values(detector_id, new_cylinder_values):
    ...
    try:
        ...
        db_client.update_data("inventario_multigas", updates, 'id_equipamento', detector_id)
